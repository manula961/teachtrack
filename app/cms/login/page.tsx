  ...
  return <>
    <main className="auth-wrap cms-auth demo-auth-wrap">
      <section className="hero">
        ...
        <div className="auth-demo-hint"><b>Demo leadership access</b><span>Select any management role below to prefill its competition demo account.</span></div>
      </section>
      ...
      <div className="auth-stack">
        <section className="auth-card">
          ...
          <form onSubmit={submit}>
            <div className="field"><label>LEADERSHIP EMAIL</label><input name="email" type="email" autoComplete="username" value={email} onChange={e=>setEmail(e.target.value)} required/></div>
            <div className="field"><label>PASSWORD</label><input name="password" type="password" autoComplete="current-password" value={password} onChange={e=>setPassword(e.target.value)} minLength={6} required/></div>
        ...
        <DemoAccessPanel portal="cms" onUse={useDemo}/>
      </div>
    </main>
    <DemoTourBubble/>
  </>
