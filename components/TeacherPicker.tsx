...
export function TeacherPicker({name,label,required=false,defaultValue=null,allowEmpty=true,placeholder='Search teacher code, ID or name…'}:Props){
 ...
 const inputId=`teacher-picker-${name.replace(/[^a-zA-Z0-9_-]/g,'-')}`
